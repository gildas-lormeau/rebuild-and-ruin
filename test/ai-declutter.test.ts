 ...
 * crosses the fat threshold from round 5 and fires declutter chains every
 ...
 * then seed 6 until the own-zone grunt cull did, then seed 0 until the
 * battery-size cannon gates did — back to seed 6.)
 *
