...
/** How long to hold the dialog open after the last entry resolves, so the
 *  reveal pulse on the final card actually gets draw frames. The render
 *  layer uses the same constant to drive the expanding ring animation. */
