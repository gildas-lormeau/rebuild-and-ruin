/**
 * Tetris-like wall piece logic for the repair/build phase — shape catalog,
 * round-weighted bag generation, draw + rotation. The `PieceShape`/`BagState`
 * types live in shared/core/pieces.ts (universal vocabulary: the Player struct
 * and renderers reference them); this file is the sim-tier algorithm over them.
 */

import type { BagState, PieceShape } from "../core/pieces.ts";
